export async function onRequestPost(context) {
  ...
  const { prompt, system, project_id, section_id, write_to_db } = body
  ...
  const anthropicRes = await fetch('https://api.anthropic.com/v1/messages', {
    ...
    body: JSON.stringify({
      ...
      system: system || 'You are a strategic planning assistant for Lee Smith, a Senior Solutions Engineering leader, helping him think through in-role projects and initiatives. Respond in markdown.',
