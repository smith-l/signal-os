-- Migration v3: populate role_prep sections from Confluence export
-- Run via: wrangler d1 execute signal-os-db --remote --file=migration_v3.sql
...
-- Clear existing role_prep content before seeding
...
- Interview Rounds — Stage-by-Stage Prep

Interview Rounds — Stage-by-Stage Prep

- Atlassian Values — Interview Prep
...
- Atlassian Product Set — Buyer Personas & What Matters
...
Mid-Market Nordics and CEE


Distributed team across multiple regions — cultural awareness, remote leadership, async communication. Directly evidenced: managed French team and Benelux/Nordics at Zoom under the EMEA North remit.
...
7 SEs — 3 senior, mix of mid-career and junior starters


Broad spread of experience. Seniors may have strong views on how things should work. New starters need structured onboarding.
...
New and growing fast, no real playbook


SE and Sales transformation need to happen in parallel — can''t build SE motion on a solid Sales foundation because the Sales foundation isn''t there yet.
...
Mostly demo-based — SEs are handed deals to demo rather than owning end-to-end


Confirmed reactive. The transformation mandate is real.
...
SE/Sales relationship


Limited — no QBR involvement, no pipeline ownership from the outset


Kira explicitly wants SEs presenting alongside AEs on QBRs and actively supporting pipeline growth from the start.
...
Limited and under-resourced — SE/CS engagement minimal today


Will change as both orgs grow. Foundation needs to be built now so the relationship is ready when CS scales.
...
Broad — SEs don''t have a joined-up talk track or coherent demo narrative


Kira wants a talk track that connects the products together, and a demo narrative that shows the platform as a whole with ease.
...
1:1s with all 7 SEs — understand current workflow, what they''re asked to do, what frustrates them. Ride-alongs on live customer calls across Nordics and CEE. Meet every AE in the territory — what do they currently use SE for, what do they wish they had? Meet CS leads — first conversation about how SE and CS currently intersect. Into the CRM — understand pipeline health, SE attachment rate, win rates. Won''t do: restructure, change coverage, make promises.
...
Share back what I''ve heard — with the SEs first, then with Kira. Introduce discovery-before-demo standard — the first non-negotiable. Start building the talk track with the senior SEs — work with what they already know. Propose first SE/AE QBR co-presentation model — small scale, test it, refine it. First CS conversation about a joint account review model on top expansion accounts.
...
Formalise the operating model — discovery standards, SE/Sales engagement model, QBR rhythm. Complete the first version of the connected talk track and demo narrative. Introduce outcome-based metrics — technical win rate, SE pipeline contribution, QBR co-presentation rate. Present findings and progress to Kira — here''s what I found, here''s what I''ve built, here''s how we measure it going forward.
...
Confirm attainment expectations and historical payout
...
Confirm grant size, 4-year vest, 1-year cliff, refresh policy
...
INSERT INTO role_prep (application_id, section_key, section_title, content, sort_order) VALUES (7, 'go_sheet', 'GO Sheet', 'Thursday 25 June, 3:00pm UK time (updated from 4pm) | Kira Lombardi, VP SE Mid-Market, Austin-basedThis is the single reference to read the morning of. Everything else in the prep hub is the depth behind it.
...
Zoom transformation — 4 to 13, meetings → UC → CCaaS → AI, direct → channel-first


Channel revenue 20% → 60% in 18 months. Framework adopted globally.
...
Managing to results / operating model


Case Request process (Story 2) — Salesforce process, data to drive behaviour change


SE attach on 75% of qualified opportunities. Shorter cycles, improved win rate.
...
Develop other leaders (explicitly called out)


Ronald (Story 8) — demo environments → QBRs → Team Leader promotion


By the time the title came up, it was a formality. He''d already done the job.
...
Helping a team member succeed when they''re not performing


Story 10 — coaching the Mitel SE on discovery (shadow, 60-day plan, win rate recovered)
...
Channel-first GTM pivot at Zoom, or Mitel post-merger rebuild
...
Putting customer first over commercial pressure


HMRC — navigating internal complexity to protect the deployment and the customer relationship
...
Difficult conversations, conflict, directness


Story 11 — SE resistant to new KPI framework (heard the substance, held the line on behaviour)
...
Real failure, recovery, what you learned


Story 12 — Case request rollout to enterprise (diagnostic error, weeks of friction, corrected)
...
- Main Role Page — role context, transformation hypothesis, 90-day plan, package

Main Role Page — role context, transformation hypothesis, 90-day plan, package

- Interview Rounds — Stage-by-Stage — what each stage assesses

Interview Rounds — Stage-by-Stage — what each stage assesses

- Kira — Model Answers in My Own Words — practiced answers in your voice

Kira — Model Answers in My Own Words — practiced answers in your voice

- Atlassian Values — Interview Prep — the five values with story angles

Atlassian Values — Interview Prep — the five values with story angles

- Core Behavioural Stories — the full story bank

Core Behavioural Stories — the full story bank', 2);
...
Another manager, Sales & Success org
...
Full prep — the five values, what each one probes, and suggested story angles — is on a dedicated page: Atlassian Values — Interview Prep
...
- Anything presented elsewhere in this prep as a "fact" about the team''s current state that isn''t directly drawn from the JD should be treated with the same caution as above — when in doubt, ask rather than assert.
...
- Cross-reference against the seven core behavioural stories already built in the Core Behavioural Stories page — several should map directly onto these five values with little rework.

Cross-reference against the seven core behavioural stories already built in the Core Behavioural Stories page — several should map directly onto these five values with little rework.', 4);
...
- Watch for word-substitution slips under pressure — "methodology" not "mythology," "surfacing" not "surfing," "that''s" not "thats." None of these change the substance but they can momentarily distract from otherwise strong answers.
...
7 SCs — 2 senior, 2 new starters, 3 mid-career
...
2:1 — SE-heavy relative to most teams
...
Previous SE promoted into the manager role, didn''t work out, left. Looking for someone to refocus, stabilise, and reignite the team. Bringing passion back is the explicit brief.
...
No structured relationship today. SCs only engage CS on existing accounts, driven by AEs working expansion opportunities — not proactive.
...
£120k base + 30% commission + £80k stock + £10k car allowance (paid monthly)
...
ASAP — but heading into holiday season, expect some slippage
...
Faizan Siddiqi (Director, SC UKI Medium Enterprise)


⏳ Meeting scheduler incoming
...
Jil Simon (verify still at Workday — Farewell post spotted)
...
Michelle Dawkins (VP SC) — separate call if unavailable
...
Manager, Solution Consulting — UKI
...
Leah Houlihan, Principal Recruiting
...
£140k–£150k base — let them respond first
...
Soumia (Head of EMEA Legal/PX) — soft assist, not a confirmed lever
...
Hiring Manager round if screen passes
...
Zoom transformation story — 4 to 13, meetings → UC → CCaaS → AI, channel-first. 90 seconds, stop.
...
Leading and developing SC/SE teams


Brief Zoom context → Ronald (demo environments → QBRs → promotion) → channel programme closes it
...
Coaching someone struggling with discovery


Mitel SE — shadowed two calls, 60-day plan, discovery framework, win rate recovered in two quarters
...
FS, public sector, healthcare, tech at Zoom — repeatable frameworks with vertical overlays, not generic demos
...
Why Workday / what do you know


Keep these separate. "Why" = people, leadership, AI value conversations + Sana shift. "What do you know" = Sana facts + CEO change
...
£140k–£150k base, in line with Atlassian target. Open on total package. Don''t lowball.
...
Closed 4 November 2025 — $1.1B. Signed 16 September 2025.
...
New "front door for work" — conversational AI layer across all company systems, not just inside Workday
...
Illuminate — narrower, embedded inside Workday workflows only
...
Live for all customers March 2026
...
Sana Learn (alongside Workday Learning) — never say "Galileo Learn"
...
Aneel Bhusri returned (co-founder), replacing Carl Eschenbach
...
Workday — TA Screen Prep (full detail)', 1);
...
AI-powered monitoring of network performance across hybrid and cloud environments. Hardware appliances plus SaaS subscription model.


Head of Network Operations, IT Director, CIO
...
Aternity (Digital Employee Experience)


End-user experience monitoring — measures how applications actually perform from the user''s device, not from the network. $100M+ revenue line.


IT Operations, CHRO, CIO — anyone accountable for employee productivity and digital experience
...
APM across cloud and on-premise — traces application performance, identifies bottlenecks, root cause analysis.


Head of Engineering, IT Operations, DevOps leads
...
Launched October 2025. High-speed data movement for AI operations — moves data between AWS, Oracle OCI, and enterprise data centres at up to 10x traditional speeds, with up to 30% cost savings.


CTO, Head of Data/AI, Cloud Architect
...
Conversational AI interface for IT operations — integrates with Microsoft Teams and Slack. Agentic AI expected summer 2026.
...
APM, observability, cloud monitoring


Riverbed''s strength is the end-user experience layer (Aternity) and network depth — Datadog is stronger in pure cloud-native environments
...
Full-stack observability, AIOps


Riverbed competes on network observability depth and the digital employee experience angle
...
Netskope / Cato Networks


SD-WAN, network security


Riverbed still has SD-WAN and WAN acceleration heritage — legacy install base is an asset
...
Endpoint monitoring via Intune/Defender


Riverbed goes deeper on application and network performance than Microsoft''s native tooling
...
Leading the AI transformation — worth knowing his narrative and public messaging
...
Key relationship — has introduced CV to hiring manager and has CTO endorsement alongside
...
Previous Director SE UK&I


Held this role as recently as March 2025. Now departed/promoted. Sets the bar for domain credibility.
...
Background, fit, domain awareness, package expectations
...
Leadership credentials, transformation story, regional strategy
...
- Don''t assume the interview stage table above is real — it isn''t confirmed by Riverbed

Don''t assume the interview stage table above is real — it isn''t confirmed by Riverbed', 1);
INSERT INTO knowledge_base (section_key, section_title, content, sort_order) VALUES ('all', 'Core Behavioural Stories', '# Core Behavioural Stories
...
Mitel won a contract to deploy a private cloud UC platform for HMRC — 85,000 users, their largest global implementation. I was named Technical Design Authority. We had five people, a six-month timeline, and a formal government procurement framework to navigate.
...
Midway through technical testing, a third-party vendor (Unify) created an obstruction that threatened to derail the timeline. We had no contractual leverage over them and HMRC''s go-live date was fixed.
...
I escalated directly to Mitel''s global executive team and worked with HMRC''s Cabinet Office stakeholders to apply commercial pressure from multiple angles. I also ran a parallel technical workstream to find an alternative path that didn''t depend on Unify''s cooperation.
...
Deployed on time. 85,000 users migrated successfully. The project became Mitel''s reference case globally for large-scale public sector private cloud deployment.
...
In complex multi-party programmes, the SE''s most important skill isn''t technical — it''s knowing when to escalate and who to escalate to. Political intelligence matters as much as technical design.
...
At Zoom, the commercial team weren''t engaging SEs early in deals. Requests came in last minute, with no context and poor preparation — SEs were walking into discovery calls and demos blind, with no real chance to add value.
...
I raised it directly with the AE manager. Nothing changed. Talking about it wasn''t shifting behaviour — I needed evidence, not just a conversation.
...
I introduced a formal case request process in Salesforce. AEs had to submit specific deal information and stage before an SE would be assigned. This did two things: it forced better-quality handoffs at the point of request, and it created a data trail I didn''t have before. At the next QBR, I used that data to show the sales team exactly how poor the information they''d been giving us actually was — not as a complaint, but as evidence they could see for themselves.
...
The AE manager started ensuring requests were submitted in full, on time, with solid data. By the following quarter, we were engaged in 75% of all deals at the correct stage — up from a position where most engagements were too late to add real value. Discovery and demos became more rounded as a result, and we saw a shorter sales cycle and an improved technical win rate off the back of it.
...
It reinforced for me that change only really happens in earnest when teams are working cross-functionally to the same goal. Process on its own doesn''t fix behaviour — what fixed it was giving Sales a reason to want the same outcome we did, with the data to show why it mattered.
...
Zoom pivoted from direct to channel-first in EMEA. There was no dedicated channel SE function — generalist SEs were trying to support partners on the side — and no structured way to bring 200+ partner SEs up to a standard good enough to run technical conversations and demos credibly.
...
Partner SEs had wildly different starting points — some were ex-Cisco engineers, others were generalist reseller staff who''d never run a CCaaS demo. One programme couldn''t serve everyone.
...
I built a dedicated internal channel SE function from scratch — started with one SE pulled across from the wider team, grew it to three (part of the team''s overall growth from 4 to 13, not additional headcount on top). In parallel, I designed a tiered onboarding programme for partner SEs — product positioning, hands-on lab work, and value-based demonstration training — with clear certification gates, and ran the first cohort myself before scaling it through a train-the-trainer model.
...
200+ partner SEs completed the programme in year one. Channel''s share of total revenue grew from approximately 20% to 60% within 18 months. The programme was adopted internationally and later rolled out globally.
...
The most scalable thing a senior SE leader can do is build something that works without them in the room.
...
An SE committed a roadmap feature to a prospect to close a deal this quarter. The sales leader escalated to me — the deal was at risk and the customer had a contract addendum referencing the feature.
...
First, talked to the SE — understood what was said, why, and whether they genuinely believed it was deliverable or felt pressured. Then talked to the AE and Sales Director to align on the commercial risk. Then brought PLM in to understand realistic timelines. Got all parties on a single call with a plan. Communicated personally to the customer — transparently, with a remediation path and a timeline. Documented the group learning as a process improvement.
...
The deal held. The customer''s trust was preserved because we were direct with them rather than hoping they wouldn''t notice. The SE learned the right lesson — not shame, but judgment for next time.
...
When something goes wrong, the SE leader''s job is to be the calmest person in the room. Blame doesn''t help the customer or the deal.
...
At Zoom during a particularly intense quarter, the SE team had three major enterprise deals, two large channel RFPs, and a company-wide product launch requiring SE enablement — all at the same time. I had to make hard coverage decisions.
...
I mapped every open activity against revenue impact and strategic priority. I pulled two SEs from lower-priority deals — having direct conversations with the relevant AEs — and redeployed them to the highest-impact work. I also pushed back on the product launch timeline, requesting a two-week delay to the SE enablement component. I didn''t ask permission — I made the call and communicated it clearly.
...
Two of the three enterprise deals closed in the quarter. The third slipped but closed the following quarter. The product launch enablement was better for the extra two weeks.
...
SE leaders who try to cover everything end up covering nothing well. The courage to say no to low-priority work is a leadership skill.
...
When I joined Zoom, the SE team was built for a meetings product. By the time I left, we were an AI-first CCaaS SE organisation. The product changed, the GTM changed, the customer conversations changed — and the team had to change with it.
...
The team grew from 4 to 13 and navigated three major product pivots without losing continuity on key accounts. Several SEs who were meeting specialists became credible CCaaS and AI practitioners within 12 months.
...
Transformation in an SE team is a people challenge more than a technical one. Most SEs want to grow — the leader''s job is to create the conditions and the conviction that it''s worth the effort.
...
Product domain. In every role I''ve taken, I''ve arrived without deep knowledge of the specific product. That''s true at Atlassian too — my background is UC and CCaaS, not Jira and Confluence. I''ve always closed that gap, but it''s always a gap at the start.
...
"The honest answer is the product depth. I''d expect to lean on the team and on [hiring manager] in the early months while I build that fluency. That''s part of why product onboarding is explicit in my 90-day plan from day one."
...
It''s honest, it''s specific, it shows self-awareness, and it connects directly to something already said in the interview. It doesn''t sound rehearsed because it''s true.
...
One of my UK SEs, Ronald, wanted to move into management. He had the right instincts but no track record of ownership beyond his own accounts — nothing yet to point to.
...
I started small and deliberate. First gave him ownership of the demo environments — making sure the team had what they needed to demonstrate consistently — with a regular slot on the team call to walk through it. As his confidence grew, I expanded what he owned: setting deadlines against goals, surfacing problems early. Within a year he was running the team''s QBRs himself — setting next quarter''s goals, calling out what was working and what wasn''t — and presenting that up to me so I could roll it into my own QBR for leadership.
...
He got the promotion and the title — team leader. By that point it was close to a formality, because he''d already built a genuine track record of ownership and team leadership. He could surface problems early, run a room, and think a quarter ahead — the actual job, not just the label.
...
Developing someone into leadership isn''t a single moment — it''s a sequence of expanding ownership, each step slightly bigger than their current confidence, with a visible moment to prove it each time. By the time the promotion conversation happens, the case has already made itself.
...
Adarna had been on my team from day zero at Zoom. She was a genuinely good people person — great at building customer relationships — but the SE role itself, with the pace of product change, wasn''t a natural fit for her. Her aligned AEs were complaining she was falling back on standard demos rather than tailoring them.
...
I had a direct conversation with her first — not to tell her what to fix, but to understand her view and what was getting in the way. She agreed she needed to step up and we set some starting points together that she was happy to commit to. The following week, no progress — she said she''d been unwell. The week after, still no progress, this time with no excuse at all. At that point I had to be honest with her about where things stood and put her on a PIP with clear steps and expectations. She agreed to them. Two weeks later, still very little movement. On that call, she finally told me the truth — she no longer enjoyed the SE role, found it too complicated, but loved working for Zoom.
...
Once I had the honest picture, it was clear she wasn''t in the wrong company, just the wrong role. We talked through what she actually enjoyed and where she came alive in her work, and it pointed clearly to Customer Success. I had a conversation with the CS leader, and a few weeks later she moved across. She went on to be a genuinely strong CS account manager.
...
If that conversation hadn''t gone that way, the PIP would have become formal and we''d have had a harder conversation about her future. But the lesson I''ve carried since is that performance management isn''t always about fixing someone in the role they''re in — sometimes it''s about getting the right people into the right roles at the right time. She''d been a great SE once; that time had passed, and she was brave enough to admit it. That honesty is what let both of us land somewhere better.
...
At Mitel, an SE on my team was technically excellent — deep product knowledge, strong in the room with IT teams — but consistently lost deals at the business case stage. He could demonstrate the platform brilliantly but struggled to connect what it did to what the customer was trying to achieve commercially. His win rate was below the team average, and post-loss feedback repeatedly cited "didn''t understand our business."
...
I shadowed him on two customer calls without intervening, to diagnose the actual gap rather than assume one. What I saw was that he led with product features before understanding what the customer needed to see — he had a plan for what to show, not a plan for what to learn first. I gave him direct, evidence-based feedback on exactly what I''d observed, and we agreed a 60-day plan: a structured discovery framework, a pre-call planning template that made him write down the business outcome he was trying to surface before every meeting, and fortnightly call reviews where we listened back together. I also paired him with a stronger commercial SE for two joint customer engagements so he could see a different approach live.
...
Within 90 days his discovery quality had measurably improved — more questions, fewer feature monologues, a clearer business case narrative. His win rate moved from below team average to in line with the team within two quarters. He went on to become one of the stronger commercial SEs on the team, and the discovery framework we built for him became part of the broader team enablement.
...
Diagnosing before fixing matters more than people think — the two shadowed calls told me more than any conversation about the problem would have.
...
At Zoom, an SE who was a strong individual contributor was actively resistant to the new engagement model and KPI framework I''d introduced — vocal about his disagreement in team meetings, to the point it was affecting the team''s adoption of the new approach. His individual performance was fine; his influence on team culture wasn''t.
...
I had a direct, private conversation — genuinely to understand his concerns first, not to deliver a verdict. He felt the new model reduced his autonomy and didn''t reflect how his enterprise accounts actually worked. Some of that was valid, so I acknowledged it directly and made two specific adjustments to the model based on his input. I was equally direct that the resistant behaviour in team settings wasn''t something I could keep allowing, regardless of whether his concerns were legitimate. We agreed clear expectations going forward.
...
He became a constructive participant rather than a resistant one — partly because he felt genuinely heard, partly because the expectations were now explicit. His input actually improved the model.
...
Resistance sometimes contains useful signal. The job is separating the substance from the behaviour and addressing both, not just shutting down the behaviour.
...
A few weeks in, I started hearing from the SE team that the enterprise AEs weren''t happy. The friction had been building for a while before it surfaced to me — the AEs were raising it directly with the SEs rather than coming to me.
...
I brought it up in my next 1-2-1 with the enterprise sales lead. The conversation made it clear pretty quickly that I''d got it wrong. In enterprise, the AE-SE relationship was already a genuine partnership — lower deal volumes, longer cycles, tight collaboration from day one. The case request process wasn''t solving a problem that existed there; it was adding overhead to something that was already working. I removed the requirement for enterprise and kept it for mid-market where it belonged.
...
The friction resolved. Mid-market continued to benefit from the process; enterprise went back to operating as they had before, with the relationship intact.
...
The lesson wasn''t just "move slower." It was that I''d made a diagnostic error — I''d assumed the same symptom existed across both segments because I''d seen it in one of them, without testing whether the context was actually the same. I''d diagnosed mid-market and treated enterprise. I now make a deliberate point of testing the problem definition with the right stakeholders before implementing anything, not after.
...
Complex delivery / enterprise credibility
...
Influencing a senior technical stakeholder


Story 1 — HMRC (alternate angle, see note)

| SE process improvement / cross-functional alignment | Story 2 — Case Request |

SE process improvement / cross-functional alignment


Story 2 — Case Request

| Partnering with Sales as a peer | Story 2 — Case Request (alternate angle, see note) |

Partnering with Sales as a peer


Story 2 — Case Request (alternate angle, see note)

| Scale / programme design / global impact / channel | Story 3 — Channel Enablement |

Scale / programme design / global impact / channel


Story 3 — Channel Enablement

| Escalation / coaching / deal rescue | Story 4 — Roadmap Feature |

Escalation / coaching / deal rescue


Story 4 — Roadmap Feature

| Prioritisation / capacity / saying no | Story 5 — Prioritisation |

Prioritisation / capacity / saying no


Story 5 — Prioritisation
...
Story 6 — Team Through Transformation

| Strategic thinking / capability planning | Story 6 — Team Through Transformation (alternate angle, see note) |

Strategic thinking / capability planning


Story 6 — Team Through Transformation (alternate angle, see note)

| Weakness / hardest part of new role | Story 7 — Genuine Weakness |

Weakness / hardest part of new role
...
Develop other leaders / grow someone into management
...
Managing underperformance / difficult performance conversations / PIPs (fit issue)
...
Coaching a skill gap (discovery, commercial acumen)


Story 10 — Coaching for Discovery

| Handling resistance to change / valid pushback vs. problematic behaviour | Story 11 — Resistance to a New Process |

Handling resistance to change / valid pushback vs. problematic behaviour


Story 11 — Resistance to a New Process

| Real failure / "build with heart and balance" / diagnostic error | Story 12 — Case Request Enterprise Rollback |

Real failure / "build with heart and balance" / diagnostic error


Story 12 — Case Request Enterprise Rollback', 1);
...
SE Manager, UKI & EMEA North


Zoom


Grew 4→13, meetings→AI, direct→channel-first, global enablement rollout
...
Director SE, Northern Europe


Mitel Networks


Regional SE leadership, cloud CX and UCaaS
...
Built SE from scratch post-merger, HMRC 85k-user deployment
...
The Junction — chose pre-sales over product when Mitel acquired Aastra
...
Deep enterprise telephony, UC, partner delivery
...
- AI-first: genuine, not performative — use Claude daily, built SE AI tools myself

AI-first: genuine, not performative — use Claude daily, built SE AI tools myself', 1);
...
This is the value hypothesis. The heart of value selling.


Surface the metrics the customer cares about in their own words. If you can''t quantify success, you haven''t qualified the deal.
...
The person who cares about outcomes, not features. Value conversations happen here.


A value conversation with a technical evaluator is interesting. A value conversation with the economic buyer moves money.
...
Strong discovery lets you shape this early — ideally in your favour.


If you''ve done value selling properly, you''ve helped the customer articulate success before the formal evaluation starts.
...
How the decision gets made, and by whom, in what order.


Map the steps, approvals, and timeline. Know where the deal can stall before it does.
...
Procurement, legal, security review — the path from yes to signature.


Often the most underestimated source of slippage. Surface it early, especially in enterprise and public sector.
...
MEDDPICC identifies the pain. Value selling prices it.


Identify and implicate the pain. Quantify the cost of inaction — the foundation of urgency.
...
The person who sells for you when you''re not in the room.


Build a champion AND arm them with the value narrative. If they can''t answer "what is this worth to us", they''ll lose internally.
...
The cost of inaction is your strongest weapon against status quo.
...
Never show the product until you understand the pain, the business impact, and who cares about solving it. A demo without discovery is a product tour — it entertains but rarely advances a deal.
...
Agree up front what the customer believes the outcome is worth. Get them to articulate it — customers trust their own numbers more than yours.
...
Value conversations happen where budget decisions are made. Ask: who in this organisation loses if the problem isn''t solved? That person needs a business case, not a feature list.
...
Success metrics before the sale


Define what "working" looks like in 12 months before the contract is signed. No agreed definition of success = no way to prove value delivered.
...
The SE as value coach


The SE''s primary tool is questions, not answers. More interested in understanding the customer''s world than showcasing product knowledge.
...
"MEDDPICC gives you the structure to qualify and manage a deal. Value selling gives you the content that fills that structure. Metrics without value selling is just a number. An Economic Buyer conversation without value selling is just a status update. They work together — MEDDPICC tells you where to focus, value selling tells you what to say when you get there."', 2);
...
Technical wins ÷ technical evaluations undertaken


The North Star. Isolates SE performance from price, timing, and relationship. High TWR + low overall win rate = Sales problem. Low TWR = SE problem.
...
Compelling Event Quality


Rubric score 1–10 per opportunity


Primary leading indicator. 7–10 = hard date + verified forcing function + explicit consequence. Below 5 = pipeline risk.
...
Qualitative — quantified per deal


Most underdeveloped skill in SE. When the customer understands what doing nothing costs, decisions speed up.
...
Opps with SE ÷ total qualified opps


Are SEs covering the right deals, early enough? Pair with win rate to prevent gaming.
...
Closed-won with demo ÷ opps that received demo


Low = poor qualification or demo quality. The discipline question.
...
POC Technical Close Rate


POCs leading to technical win ÷ total POCs run


Primary metric, not vanity. Low rate = poor POC design or wrong qualification — both fixable.
...
Sum of closed-won ARR with SE attachment


Commercial impact of the SE function. Also: ARR per SE FTE for headcount justification.
...
AE rating of SE partnership (1–10 quarterly)


Almost no one does this. Highly effective. Three questions, quarterly. Surfaces patterns fast.
...
Hours on defined tasks ÷ available hours × 100


Sweet spot 70–80%. Above 85% = capacity risk.
...
Close date − qualified engagement date (days)


SE-attached deals should be shorter. If not, the SE is adding process not value.
...
Bi-weekly 1:1s with every SE


Genuine conversations, not reviews. What do they find hard? What''s working? What would they change?
...
Into the CRM and KPIs immediately


Use data to sharpen questions, not form conclusions. Understand what''s being measured and what''s being ignored.

| Sit in on live customer calls | Watch how the team operates in the real world, not how they describe it. |

Sit in on live customer calls


Watch how the team operates in the real world, not how they describe it.
...
Meet every AE and sales leader


How do they use SE? Where do they feel unsupported? What do they wish the SE team did differently?

| Begin the CS conversation | Understand the post-sale relationship and where SE hands off. |

Begin the CS conversation


Understand the post-sale relationship and where SE hands off.
...
Share back what I''ve heard


People who were listened to need to know it mattered. Build trust before building change.

| Shape the operating model with the team | Not imposed on them. Built together from two months of learning. |

Shape the operating model with the team


Not imposed on them. Built together from two months of learning.

| Deepen the CS relationship | Frame SE''s role in retention, not just acquisition. |

Deepen the CS relationship


Frame SE''s role in retention, not just acquisition.
...
Formalise the Sales partnership


Clear rules of engagement — when SE attaches, how deals are qualified, what the AE can expect.
...
Establish what SE should NOT do


Protecting capacity is as important as deploying it. No demo without discovery is the first boundary.
...
Formalise the operating model


Built from two months of learning. Discovery standards, demo quality framework, POC methodology, coverage model.
...
Technical win rates, deal influence, pipeline contribution. Replace activity counting with impact measurement.

| Formalise the SE–CS bridge | Shared customer outcomes across the full lifecycle, not a hard handoff at signature. |

Formalise the SE–CS bridge


Shared customer outcomes across the full lifecycle, not a hard handoff at signature.
...
Where does each SE want to go? What does the team need to develop to serve the next 12 months of the business?
...
Present 90-day findings and signal direction


To leadership: here''s what I found, here''s what I''m building, here''s how we''ll measure it.
...
"I don''t arrive with a change agenda. I arrive with questions. The first 30 days are about earning the right to lead — understanding the team, the data, and the relationships before touching anything. The operating model comes from listening, not from importing what I did somewhere else."', 4);
...
A repeatable technical discovery flow. Mandatory before any demo or POC commitment.


Discovery is the foundation of everything. Without it, Metrics are guesswork and demos are product tours.
...
2. Demo Quality Framework


Standards for personalisation, prep discipline, and the tell-show-tell structure. AI-assisted prep as default.


A demo earned through discovery. Tailored to the customer''s pain, not the product''s features.
...
Qualification gate, mutually-agreed success criteria, fixed time-box, decisive go/no-go. POC technical close rate tracked as primary metric.


A POC is the most expensive thing an SE team does. It has to earn its place.
...
Deal reviews, forecast discipline, pipeline inspection, coverage model, 1:1 cadence, quarterly Sales NPS.


Consistent execution doesn''t happen by accident. It happens because the rhythm makes it the default.
...
Individual development plans, succession planning, coaching cadence, hiring standards, progression paths.


The team is the product. Build a bench, not just fill seats.
...
Demo Quality Framework


Demo-to-Win Conversion


Demo prep time vs outcome
...
POC qualification gate pass rate
...
Forecast accuracy, SE utilisation
...
The operating model comes from listening, not from importing what I did somewhere else.', 5);
